      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="animate-fade-in [animation-delay:100ms]">
            <h4 className="text-xl font-bold mb-4">{t.footer.hotelName}</h4>
          ...
          <div className="animate-fade-in [animation-delay:300ms]">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">{t.footer.hotelPhone}</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-2 text-primary" />
                <span className="text-muted-foreground">{t.footer.hotelEmail}</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 mt-8 text-center text-muted-foreground">
          <p>&copy; {currentYear} {t.footer.hotelName}. {t.footer.allRights}</p>
        </div>
      </div>
    </footer>
  );
